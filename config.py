...
class Exp(MyExp):
    def __init__(self):
        ...
        self.cls_names = ['icon', 'text', 'image','linebox']
        ...
        data_root = "/data/screen_analysis/0002_sa_task/0010_v1.5_filtered_linebox_yolox"
        self.data_dir = data_root + "/labelme"
        self.train_ann = '/home/tingfengwu/datasets_206/train_oneclass_12.json'
        self.val_ann = '/home/tingfengwu/datasets_206/train_oneclass_12.json'
